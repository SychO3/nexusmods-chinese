...
(function (window) {
  ...
  zhCN.public = Object.assign(zhCN.public || {}, {
    ...
    'Oops!': '哎呀！',
    'The page you are trying to access is not available to guests, but may be available if you sign in.': '该页面需要登录后才能访问。',

    'You need an account to download.': '你需要一个账户才能下载。',
    'Download App': '下载应用程序',
    'We help millions of players make their': '我们帮助数百万玩家打造他们',
    'game better.': '更好的游戏。',
    'As the world’s largest modding platform, we empower a global community of players and creators to shape games their way, and have done so since 2001.': '作为世界上最大的模组平台，我们为全球玩家和创作者提供力量，让他们以自己的方式塑造游戏，自 2001 年以来一直如此。',
    'How we do it': '我们怎么做',
    'With over': '超过 ',
    'across': '基于 ',
    '+ games': '+ 游戏',
    ', Nexus Mods is the trusted place to discover, download, and share game-changing content.  From small tweaks to complete overhauls, everything lives here.': '，Nexus Mods 是发现、下载和分享改变游戏内容的地方。从小调整到全面改造，一切都在这里。',
    'A Home for Mods': '模组之家',
    'Discover, download, and share mods across thousands of games, from tiny tweaks to total overhauls that transform your experience.': '发现、下载和分享数千款游戏的模组，从小调整到全面改造，改变你的体验。',
    'Tools that empower': '工具，赋予你力量',
    'We build tools and services that make modding simple and accessible, from our Vortex mod manager to powerful Collections.': '我们构建工具和服务，使模组制作简单且易于访问，从我们的 Vortex 模组管理器到强大的合集。',
    'Thriving community': '蓬勃发展的社区',
    'Millions of players and creators shape our platform, and we fuel their creativity with rewards and community tools.': '数百万玩家和创作者塑造我们的平台，我们通过奖励和社区工具激发他们的创造力。',
    'Giving back': '回馈社区',
    'Our Donation Points system rewards creators for the mods they share, supporting the people who make this community.': '我们的捐赠点系统奖励分享模组的创作者，支持这个社区的人们。',
    'Join the team': '加入团队',
    'We’re growing.': '我们正在成长。',
    'Want to help shape modding’s future?': '想帮助塑造模组的未来？',
    'Why we do it': '我们为什么这样做',
    'To give players and creators the freedom to personalise their games, share their creativity, and build the experiences they wish existed. We believe modding should be accessible, safe, and rewarding for all.': '给玩家和创作者自由地个性化他们的游戏，分享他们的创造力，并构建他们希望存在的体验。我们相信模组应该对所有人开放、安全且有回报。',
    'Creators first': '创作者优先',
    'Mod authors drive the ecosystem, and we’re committed to supporting and rewarding their work.': '模组作者塑造生态系统，我们致力于支持并奖励他们的工作。',
    'Open and accessible': '开放且易于访问',
    'Modding should be for everyone. We design our platform with accessibility, and inclusivity in mind.': '模组应该对所有人开放。我们设计平台时考虑到可访问性和包容性。',
    'Player freedom': '玩家自由',
    'Your game, your way. We support player choice and help communities express themselves through mods.': '你的游戏，你的方式。我们支持玩家选择，并帮助社区通过模组表达自己。',
    'Community-driven': '社区主导',
    'We build Nexus Mods with our community. Their feedback shapes our roadmap, our tools, and future.': '我们与社区一起构建 Nexus Mods。他们的反馈塑造我们的路线图、工具和未来。',
    'Make money modding': '制作付费模组',
    'We pay creators': '我们支付创作者',
    'over $4.2 million a year': '每年超过 $420 万美元',
    ...
    'thousand': ' 千',
    'Hosted mods': '托管模组',
    'How we got here': '我们是怎么走到现在的',
    'Nexus Mods began in 2001 when our founder, Robin (Dark0ne), built a simple site to make sharing mods easier. A small fan project grew rapidly as more players and creators joined, turning hundreds of uploads into thousands and eventually hundreds of thousands.': 'Nexus Mods 始于 2001 年，当时我们的创始人 Robin (Dark0ne) 构建了一个简单的网站，使分享模组更容易。一个小型粉丝项目迅速发展，随着更多玩家和创作者加入，数百个上传变为数千个，最终达到数十万。',
    'What began as a one-person effort is now a platform supported by a dedicated team and a global community of millions. But our purpose hasn’t changed, we’re here to make modding better for everyone and help people share the things they create.': '起初只是一个人的努力，现在是一个由 dedicated team 和全球数百万社区支持的平台。但我们的目的没有改变，我们在这里让模组对所有人更好，并帮助人们分享他们创造的东西。',
    'Who we are': '我们是谁',
    'We’re a global team of developers, designers, community managers, support specialists and product thinkers, but above all, we’re players and creators. Our staff includes active mod authors as well as modders, and we care about this community because we’re part of it. Our goal is to build tools that make modding powerful, seamless and fun.': '我们是一个全球团队，包括开发人员、设计师、社区管理员、支持专家和产品思想家，但最重要的是，我们是玩家和创作者。我们的员工包括活跃的模组作者以及模组制作者，我们关心这个社区，因为我们就是其中的一部分。我们的目标是构建工具，使模组制作强大、无缝且有趣。',
    'What the future holds': '未来会怎样',
    'We’re working toward a future where every player and creator can personalise their games, share their creativity, and build the experiences they wish existed. Our goal is to make modding accessible, safe, and rewarding for everyone.': '我们致力于打造一个未来，让每个玩家和创作者都能个性化他们的游戏，分享他们的创造力，并构建他们希望存在的体验。我们的目标是让模组对所有人开放、安全且有回报。',
    'Catch up on what’s new': '了解最新动态',
    'Featured by': '由以下内容精选',
